...
-   Lowe 2022: David M Lowe, Li-An K Brown, Kashfia Chowdhury, et
    al. Favipiravir, lopinavir-ritonavir or combination therapy (FLARE):
    a randomised, double blind, 2x2 factorial placebo-controlled trial
    of early antiviral therapy in COVID-19. medRxiv. doi:
    10.1101/2022.02.11.22270775.
    [Link](https://www.medrxiv.org/content/10.1101/2022.02.11.22270775v1).

A Ruzhentsova 2021 tanulmány egyszerre tartalmazott járó- és
fekvőbetegeket, de szerencsére a számunkra kritikus eredményeket
külön-külön is közölte, így felhasználható a mostani meta-analízisben.
...
Ebben szerencsénk van: Lowe 2022 kivételével az összes tanulmány
pontosan ugyanazt a két végpontot nézte: a vírusürítés megszűnéséig
eltelő időt (“time to viral clearence”) és a klinikai javulás
bekövetkezéséig eltelő időt (“time to clinical improvement”). Sajnos
Lowe 2022 más, és ezekkel közös nevezőre nem hozható végpontot használt,
viszont a mellékletben közölt adatok lehetővé teszik a vírusürítés
megszűnéséig eltelő idő visszaszámolását, így abban az elemzésben
felhasználható ez a tanulmány is.
...
Módszertani szempontból is szerencsénk van: Lowe 2022 kivételével minden
tanulmány eltelt időként kezelte mindkét végpontot, és mindegyik
hazárdhányadossal (HR) mérte le a kezelés hatását. A Lowe 2022
tanulmányból kiszedhető adatok is lehetővé teszik HR számítását a
vírusürítés megszűnéséig eltelő időre vonatkozóan.
...
(standard ellátás) használt, míg a másik három tanulmány
...
volt. (Pontosabban szólva Lowe 2022 egy másik gyógyszert is vizsgált,
sőt, még annak a favipiravirral vett együttes hatását is, de most csak a
favipiravirra vonatkozó adatokat fogjuk használni abból a tanulmányból.)
Ez mindenképp szükségessé tesz majd egy alcsoport-analízist.
...
Lowe 2022 esetében a Supplementary Figure 4, illetve az alatta
szerencsére közölt számszerű értékek lehetővé teszik HR számolását:
...
Ez alapján a mostani elemzésben felhasznált konkrét számok, azok
cikkbeli forrásával együtt:
...
| Lowe 2022        | Time to viral clearance      | Lásd fenti számítás                                                                                                                        | Lásd fenti számítás | 1.54  | 0.91          | 2.62           | 54  | 52  |
...
Az eredmény szerint a favipiravir nem változtat érdemben a helyzeten (HR
= 1,01), és a hatás természetesen nem is szignifikáns (95% CI:
0,78–1,32). A klinikai javulás bekövetkezéséig eltelő idő esetében a két
alcsoport már inkább eltér; az összesített eredmény szerint a
favipiravir hat ugyan (HR = 1,07), ám nem szignifikáns mértékben (95%
CI: 0,71–1,61).
